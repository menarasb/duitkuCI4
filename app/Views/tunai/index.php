...
<div class="page-header">
    <div class="page-title">
        <h3>Pengeluaran dan Pemasukan Tunai</h3>
    </div>
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Data Tunai </span></li>
        </ol>
    </nav>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
        <div class="widget-content-area br-4">
            <table>
                <tr>
                    <td>
                        <form action="/tunai/bulan_tahun" method="POST" class="d-inline">
                    ...
                    <td>
                        <button href="/tunai/create" type="submit" class="btn btn-warning mb-4 ml-3">Pilih</button>
                        </form>
                        <a href="/tunai/create" class="btn btn-primary mb-4 ml-3">Tambah Transaksi</a>
                    </td>
                </tr>
            </table>
        ...
        $('#example').DataTable({
            ...
            "columns": [{
                    ...
                    render: function(data) {
                        return '<a href="/tunai/'+data.id+'">'+data.date+'</a>';
                    }
                },
                {
                    data: "pemasukan",
...
<script>
    ...
    const url = '/dataTunai/dataBulan';
    const urlSelected = '/dataTunai/sessionBulanTahun';
    const urlTahun = '/dataTunai/dataTahun';
...
<script>
    const jsonRek = '/dataTunai/dataTunai';
